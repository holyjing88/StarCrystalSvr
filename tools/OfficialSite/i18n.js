(function () {
  ...
  var I18N_COMMON = {
    en: {
      ...
      footer_brand: '星澜无界科技(深圳)有限公司',
      footer_copy: '© Xinglan Wujie Technology (Shenzhen) Co., Ltd.'
    },
    zh: {
      lang_label: '语言',
      nav_home: '首页',
  ...
  var I18N_HOME = {
    en: {
      meta_title: 'Xinglan Wujie Technology (Shenzhen) Co., Ltd.',
      meta_desc: 'Xinglan Wujie Technology (Shenzhen) Co., Ltd. — SCPlayer multimedia player and casual games platform: Vampire Dormitory, Brain Master, Save the Lord, and more.',
      ...
      hero_lead: '<strong>Xinglan Wujie Technology (Shenzhen) Co., Ltd.</strong> builds multimedia playback and lightweight gaming ecosystems — <strong>SCPlayer</strong>, our Unity media player, and the <strong>StarCrystal Mini Games Platform</strong>, featuring Vampire Dormitory, Brain Master, Save the Lord, and more.',
      ...
      about_title: 'About Xinglan Wujie Technology (Shenzhen) Co., Ltd.',
      about_body: '<strong>Xinglan Wujie Technology (Shenzhen) Co., Ltd.</strong> stands for boundless content, focused experience — reliable multimedia and game tech to reach more users. Our team covers Unity clients, Go backends, and H5 publishing from SCPlayer to platform launch.',
      ...
      contact_email: 'Email: ',
      contact_brand: 'Xinglan Wujie Technology (Shenzhen) Co., Ltd.',
    ...
    zh: {
      meta_title: 'Xinglan Wujie Technology (Shenzhen) Co., Ltd. · 星澜无界科技(深圳)有限公司',
      meta_desc: 'Xinglan Wujie Technology (Shenzhen) Co., Ltd. — SCPlayer 多媒体播放器与星澜小游戏平台，吸血鬼宿舍、最强大脑、拯救主公等精品休闲游戏。',
      nav_products: '产品',
      nav_games: '游戏',
      nav_about: '关于',
      nav_contact: '联系',
      ...
      hero_lead: '<strong>Xinglan Wujie Technology (Shenzhen) Co., Ltd.</strong>（星澜无界科技(深圳)有限公司）专注多媒体播放与轻量游戏生态：自研 <strong>SCPlayer</strong> 播放器与 <strong>星澜小游戏平台</strong>，持续推出吸血鬼宿舍、最强大脑、拯救主公等原创小游戏。',
      ...
      about_title: '关于星澜无界科技(深圳)有限公司',
      about_body: '<strong>Xinglan Wujie Technology (Shenzhen) Co., Ltd.</strong> 致力于「内容无界、体验有界」——用可靠的多媒体与游戏技术，让优质内容触达更多用户。团队具备 Unity 客户端、Go 服务端与 H5 发行全链路能力，从 SCPlayer 播放到小游戏平台上架，形成完整产品矩阵。',
      ...
      contact_email: '企业邮箱：',
      contact_brand: 'Xinglan Wujie Technology (Shenzhen) Co., Ltd. · 星澜无界科技(深圳)有限公司',
      privacy_title: '隐私政策',
    ...
    ur: {
      meta_title: 'Xinglan Wujie Technology (Shenzhen) Co., Ltd.',
      meta_desc: 'Xinglan Wujie Technology (Shenzhen) Co., Ltd. — SCPlayer ملٹی میڈیا پلیئر اور کیژول گیمز پلیٹ فارم: Vampire Dormitory، Brain Master، Save the Lord وغیرہ۔',
      ...
      hero_lead: '<strong>Xinglan Wujie Technology (Shenzhen) Co., Ltd.</strong> ملٹی میڈیا پلے بیک اور ہلکے گیمز کے ماحولیاتی نظام بناتی ہے — <strong>SCPlayer</strong> Unity پلیئر اور <strong>StarCrystal Mini Games Platform</strong>، جس میں Vampire Dormitory، Brain Master، Save the Lord وغیرہ شامل ہیں۔',
      ...
      about_title: 'Xinglan Wujie Technology (Shenzhen) Co., Ltd. کے بارے میں',
      about_body: '<strong>Xinglan Wujie Technology (Shenzhen) Co., Ltd.</strong> لامحدود مواد، مرکوز تجربہ — قابل اعتماد ملٹی میڈیا اور گیم ٹیکنالوجی۔ Unity کلائنٹ، Go بیک اینڈ، H5 اشاعت — SCPlayer سے پلیٹ فارم لانچ تک۔',
